...
public class SecurityParameter extends AbsOpenApiSchema<OAI3, SecurityParameter> {
  ...
  @Override
  public SecurityParameter copy(OAIContext<OAI3> context, boolean followRefs) {
