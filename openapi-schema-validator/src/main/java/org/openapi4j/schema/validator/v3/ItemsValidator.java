 ...
 */
class ItemsValidator<V> extends BaseJsonValidator<OAI3, V> {
  ...
  ItemsValidator(final ValidationContext<OAI3, V> context, final JsonNode schemaNode, final JsonNode schemaParentNode, final SchemaValidator<V> parentSchema) {
