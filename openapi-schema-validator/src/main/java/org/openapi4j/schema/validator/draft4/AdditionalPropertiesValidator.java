 ...
 */
class AdditionalPropertiesValidator extends BaseJsonValidator {
  ...
  AdditionalPropertiesValidator(final ValidationContext context, final JsonNode schemaNode, final JsonNode schemaParentNode, final SchemaValidator parentSchema) {
