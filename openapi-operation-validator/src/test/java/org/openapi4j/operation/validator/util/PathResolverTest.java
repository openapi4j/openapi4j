...
public class PathResolverTest {
    ...
    public void getResolvedPath() throws Exception {
      ...
      // anchor first
      OAIContext context = new OAI3Context(URI.create("http://bit.ly/348ujup#anchor?query=value"));
      assertEquals("/348ujup", PathResolver.instance().getResolvedPath(context, ""));
      // query first
      context = new OAI3Context(URI.create("http://bit.ly/348ujup?query=value#anchor"));
      assertEquals("/348ujup", PathResolver.instance().getResolvedPath(context, ""));
    }
